...
const article_1 = __importStar(require("../../validations/article"));
...
articleRouter.post("/", checkIsLoggedIn_1.default, isAdmin_1.default, multer_1.default.single("image"), article_1.default, articles_1.default);
// Get all articles
...
// logged in
articleRouter.delete("/:id", checkIsLoggedIn_1.default, isAdmin_1.default, articles_1.deleteArticle);
// Update article should be an admin, that means has to be logged in
articleRouter.patch("/:id", checkIsLoggedIn_1.default, isAdmin_1.default, multer_1.default.single("image"), article_1.validateUpdateArticle, articles_1.updateArticle);
// like or dislike article
articleRouter.post("/:articleId", checkIsLoggedIn_1.default, articles_1.likeOrDislike);
