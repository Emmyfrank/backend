...
articleRouter.post("/", checkIsLoggedIn_1.default, isAdmin_1.default, article_1.default, articles_1.default);
// Get all articles
...
articleRouter.patch("/:id", checkIsLoggedIn_1.default, isAdmin_1.default, article_1.validateUpdateArticle, articles_1.updateArticle);
