...
exports.assignRoleToUser = exports.loginUser = exports.deleteUser = exports.getSingleUser = exports.registerUser = exports.getAllUsers = void 0;
...
const registerUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const hashedPassword = yield bcrypt_1.default.hash(password, Number(process.env.SALT_NUMBER));
        const newUser = new userModel_1.default({ password: hashedPassword, email, username, name });
